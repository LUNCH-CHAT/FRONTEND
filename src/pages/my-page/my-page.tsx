    ...
    return(
        <div className="px-[20px]">
            <div className="flex gap-[16px]">
                <img
                    src="/src/assets/images/sample-profile.png"
                    alt="마이 프로필"
                ...
                <div className="w-full">
                    ...
                    <p className="text-black text-[13px] font-[pretendard] font-regular mb-[6px]">21학번, 컴퓨터공학과</p>
                    <p className="text-[#7D7D7D] text-[13px] font-[pretendard] font-regular mb-[8px]">프로창업러 | 교환 준비생 | 취미 요가</p>
                    <div className="flex gap-[6px]">
                        <p className="inline-block px-[9px] py-[6px] border border-[#FF7C6A] rounded-[15px] text-black text-[13px] font-[pretendard] font-light leading-[11px]">창업</p>
                        <p className="inline-block px-[9px] py-[6px] border border-[#FF7C6A] rounded-[15px] text-black text-[13px] font-[pretendard] font-light leading-[11px]">교환학생</p>
            ...
            <div className="w-full border border-[#D4D4D4] mt-[29px] rounded-[10px] flex justify-center items-center">
                <div className="flex w-[80%] justify-center items-center my-3">
                    <div className="w-[60px] flex flex-col items-center">
                        <img 
                            src="/src/assets/icons/received-request.svg"
                            alt="받은 요청 이미지"
                    ...
                    <div className="w-[60px] flex flex-col items-center">
                        <img 
                            src="/src/assets/icons/sent-request.svg"
                            alt="보낸 요청 이미지"
                            className="size-[32px] mb-[6px]"
                        />
                        <p className="text-black text-[13px] font-[pretendard] font-medium mb-[2px]">3건</p>
                    ...
                    <div className="w-[60px] flex flex-col items-center">
                        <img 
                            src="/src/assets/icons/tag-select.svg"
                            alt="매칭 완료 이미지"
                            className="size-[32px] mb-[6px]"
                        />
                        <p className="text-black text-[13px] font-[pretendard] font-medium mb-[2px]">3건</p>
