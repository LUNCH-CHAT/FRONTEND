...
export default function ProfileCompletePage() {
  ...
  return (
    <div className={`min-h-screen flex flex-col justify-center px-[65px] text-center text-white font-[pretendard] bg-gradient-to-b from-[#FFECEB] via-[#FF9B8E] to-[#FF7C6A] 
      ...
      {step >= 0 && (<p className="text-[22px] font-semibold mb-[31px] animate-fade-up">{uniName}학교 런치챗</p>)}
      {step >= 1 && (<p className="text-[22px] font-bold mb-[31px] animate-fade-up"><span className="font-black">{name}</span>님, 환영합니다!</p>)}
      {step >= 2 && (<h1 className="text-[20px] font-medium mb-[27px] animate-fade-up">Lunch with Insight!</h1>)}
      {step >= 3 && (
