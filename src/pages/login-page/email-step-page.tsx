...
export default function EmailStepPage() {
  ...
  return (
    <div>
      {/*<BackHeader/>*/}
      {step === "email" && (
        <div className="flex flex-col min-h-screen px-[20px] pt-[90px] pb-[23px]">
          <p className="text-black text-[20px] font-[pretendard] font-semibold leading-[22px] mb-[44px]">
      ...
      {step === "code" && (
        <div className="flex flex-col min-h-screen px-[20px] pt-[71px] pb-[23px]">
          <p className="text-black text-[20px] font-[pretendard] font-semibold leading-[30px] mb-[44px] text-center">
